...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-6">
            <h3><?php echo isset($data) ? 'Edit' : 'Tambah'; ?> Tugas</h3>
            ...
            <form method="POST" action="<?php echo isset($data) ? 'index.php?page=tugas&action=update' : 'index.php?page=tugas&action=store'; ?>">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="deskripsi" class="form-control" rows="4" placeholder="Deskripsi Tugas" required><?php echo isset($data) ? $data['deskripsi'] : ''; ?></textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <a href="index.php?page=tugas" class="btn btn-secondary">Batal</a>
                </div>
            </form>
        </div>
    </div>
